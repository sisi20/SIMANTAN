...
<body>
	<form method="post" action="">
		<table>
			...
			<tr>
				<td>
				<td><input type="text" name="kegiatan_jmlpeserta" value="<?= set_value('kegiatan_jmlpeserta'); ?>" placeholder="Jumlah Peserta Kegiatan"></td>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					...
					<textarea name="prioritas_alasan" placeholder="Alasan Prioritas Kegiatan" rows="4" cols="25"><?= set_value('prioritas_alasan'); ?></textarea>
				</td>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<textarea name="skema_proses_masuk_keluar" placeholder="Proses Peserta Masuk Dan Keluar Kampus" rows="4" cols="25"><?= set_value('skema_proses_masuk_keluar'); ?></textarea>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>
				<td><textarea name="skema_penerapan_prokes" placeholder="Penerapan Prokes Ke Peserta" rows="4" cols="25"><?= set_value('skema_penerapan_prokes'); ?></textarea></td>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>
				<td><textarea name="skema_kegiatan_berlangsung" placeholder="Skema Selama Kegiatan Berlangsung" rows="4" cols="25"><?= set_value('skema_kegiatan_berlangsung'); ?></textarea></td>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>
				<td><textarea name="skema_kegiatan_selesai" placeholder="Skema Setelah Kegiatan Selesai" rows="4" cols="25"><?= set_value('skema_kegiatan_selesai'); ?></textarea></td>
				</td>
			</tr>
			<tr>
				<td>
