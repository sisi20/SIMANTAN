			...
			<tr>
				...
				<td>
					<select name="prioritas" value="<?= set_value('prioritas'); ?>" class="form-control">
						<option value="<?= set_value('prioritas'); ?>"><?= set_value('prioritas'); ?></option>
				...
				<td>
					<select name="penanggung_jawab" value="<?= set_value('penanggung_jawab'); ?>" class="form-control">
						...
						<?php foreach ($listUser as $u) : ?>
							<option value="<?= $u->email; ?>" <?php if(set_value('penanggung_jawab') == $u->email) {echo 'selected';}?>><?= $u->gelar_depan . $u->nama . $u->gelar_akademik; ?></option>
						<?php endforeach; ?>
					</select>
					...
					<tr>
						...
						<td>
							<div class="form-check form-check-inline">
								<input type="checkbox" name="tempatOut" id="tempat1" value="Outdoor" class="form-check-input" onclick="myFunction()">
								<label class="form-check-label" for="tempat">Outdoor</label>
							</div>
							<div class="form-check form-check-inline">
								<input type="checkbox" name="tempatIn" id="tempat2" value="Indoor" class="form-check-input" onclick="myFunction()">
								<label class="form-check-label" for="tempat">Indoor</label>
							</div>
						</td>
					<tr>
					...
					<tr>
						...
						<div class="input-group-btn">
							<td><button type="button" id="tambahOut" class="btn btn-success" style="visibility: hidden;">Add</button>
							    <button type="button" id="removeOut" class="btn btn-danger" style="visibility: hidden;">Delete</button></td>
						</div>
						</td>
					</tr>
					<tr>
						...
						<div class="input-group-btn">
							...
							<button type="button" id="removeIn" class="btn btn-danger" style="visibility: hidden;">Delete</button></td>
						</div>
						</td>
					</tr>
